...
Read and follow the research procedure from `.Codex/skills/agent-integration/researcher.md`.
...
Read and follow the procedure from `.Codex/skills/agent-integration/test-writer.md`.
...
Read and follow the implement procedure from `.Codex/skills/agent-integration/implementer.md`.
